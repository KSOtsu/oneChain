...
var index = new function() {
     ...
     *
     */
    this.prng = function(len) {
        if(len === undefined) len=16;

        var entropy = randomBytes(len);
        var result = 0;
     ...
     */
    this.rbeta = function(n, alpha, beta, loc) {
     ...
     * @returns {Array} Random variates array
     */
    this.rcauchy = function(n, loc, scale) {
        n = this._v(n, "n");
        loc = this._v(loc, "r", 0);
     ...
     * @returns {Array} Random variates array
     */
    this.rgamma = function(n, alpha, rate) {
     ...
     * @returns {Array}
     */
    this.rint = function(n, min, max, inclusive) {
        n = this._v(n, "n");
        min = this._v(min, "int");
        max = this._v(max, "int");
        if(inclusive === false) {
     ...
     * @returns {Array} Random variates array
     */
    this.rlaplace = function(n, loc, scale) {
        n = this._v(n, "n");
        loc = this._v(loc, "r", 0);
        scale = this._v(scale, "nn", 1);
     ...
     * @returns {Array} Random variates array
     */
    this.rlnorm = function(n, meanlog, sdlog) {
        n = this._v(n, "n");
     ...
     * @returns {Array} Random variates array
     */
    this.rnbinom = function(n, size, p, mu) {
        n = this._v(n, "n");
     ...
     */
    this.rword = function(len, alphabet) {
        len = this._v(len, "n");
     ...
     */
    this.sample = function(collection, n, replace, ratios) {
     ...
     *
     */
    this.visualize = function(data, domID, options) {
        var defaultOptions = {
     ...
     * @private
     */
    this._getCumulativeProbs = function(ratios, len) {
    ...
    this._sampleOneIndex = function(cumulativeProbs) {
    ...
    this._v = function(param, type, defaultParam) {
     ...
     */
    this.rfml = function (n, loc, p, cap, trace) {
        n = this._v(n, "n");
